...
description={\hspace{2 mm}é o ramo da Física que usa métodos da teoria das probabilidades e estatística
ferramentas matemáticas e computacionais para lidar com sistemas físicos formados por um número muito
grande de elementos. Seu principal objetivo é esclarecer as
propriedades globais, com base no comportamento médio de seus constituintes. Nos últimos anos técnicas
da  Física Estatística têm sido utilizadas para estudar problemas de outras áreas de conhecimento (Biologia, Economia, etc)
que lidam com sistemas formados por um número muito
grande de elementos}}
