...
A classe principal do AIAF é a classe \textit{Project}. Todas as interações do usuário com a \textit{GUI} (\textit{Graphical User Interface})
...
o RedeCrítica (análise de limiares) e o Dendo (clusterização), os três desenvolvidos pelo FESC. Por serem codificados em Fortran foi necessário o pacote
Gfortran \cite{gfortran}.
