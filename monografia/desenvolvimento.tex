...
O desenvolvimento interativo e incremental tem se mostrado ultimamente como um processo de desenvolvimento alternativo ao modelo em cascata, e traz
grandes vantagens por garantir ciclos menores de desenvolvimento e uma divisão do problema em problemas menores. A metodologia de desenvolvimento adotada
...
A cada interação dentro do ciclo, o produto gerado é considerado uma extensão de um produto mais antigo. Esse modelo utiliza muidas das fases do modelo em
...
\caption{Modelo de desenvolvimento em espiral.}
\label{fig:espiral}
\end{figure}

No contexto do projeto, apenas uma parte da espiral foi percorrida, resultando em um primeiro protótipo. A parte de validação e verificação não foi realizada,
sendo imprescindível na concepção de novos requisitos e o início de um novo ciclo da espiral.
